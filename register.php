...
<? 
	...
	if (isset($_POST['login']))
		...
		elseif ((StrLen($Login) < 4) or (StrLen($Login) > 10)) 
			...
			{
				echo "Le nom de connexion doit comporter plus de 4 caracteres et moins de 10 caracteres, veuillez le saisir a nouveau.";
			}
			
		elseif ((StrLen($Pass) < 4) or (StrLen($Pass) > 10)) 
		
			{
				echo "Le mot de passe doit comporter plus de 4 caracteres et moins de 10 caracteres, veuillez le saisir a nouveau.";
			}
			
		elseif ((StrLen($Repass) < 4) or (StrLen($Repass) > 10)) 
			{
				echo "Confirmez que le mot de passe doit contenir plus de 4 caracteres et moins de 10 caracteres, veuillez le saisir à nouveau.";
			}
